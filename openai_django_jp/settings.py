...
SECRET_KEY = 'django-insecure-%@izl!)^bri$i$43s_u-q1dgjo_i66&_2g$ji4p*zf&%=r1kcb'
...
ROOT_URLCONF = 'openai_django_jp.urls'
...
WSGI_APPLICATION = 'openai_django_jp.wsgi.application'
